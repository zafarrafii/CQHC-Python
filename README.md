...
- [`notes.ipynb`](#notesipynb): Jupyter notebook with some notes to justify and evaluate the CQT-SEC.
...
This Jupyter notebook shows some notes to justify and evaluate the constant-Q transform spectral envelope coefficients (CQT-SEC).
