...
- [`analysis.ipynb`](#analysisipynb): Jupyter notebook with some analysis to justify and evaluate the CQT-SEC.
...
This Jupyter notebook shows some analysis to justify and evaluate the constant-Q transform spectral envelope coefficients (CQT-SEC).
