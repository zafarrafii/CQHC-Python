...
%functional
%
%We do not claim that it is perfect, but it's a better approximation
...
%We then point out to a first property that 

%  Theorem, Lemma, Proposition, Corollary, Postulate, Statement, Fact, Observation, Expression, Fact, Property, Conjecture and Principle
