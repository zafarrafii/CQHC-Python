...
\emph{Observation 2: the FT of a convolution of two functions is equal to the point-wise product of their FTs, a property also known as the convolution theorem \cite{proakis1995}.}
...
Once the CQT spectrum has been decomposed into a spectral envelope and a pitch component, we can then assumed that most of the pitch information has been removed from the envelope which now mostly contains the timbre information. We can think of the spectral envelope as a pitch-normalized spectrum ...
