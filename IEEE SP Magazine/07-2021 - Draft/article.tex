...
We propose to measure the discriminative power of the CQT-SECs by evaluating them on the NSynth dataset, a large-scale of annotated musical notes which is publicly available \cite{engel2017}. 

Explain NSynth
Compare to the MFCCs
CQT-SECs computed with some parameters
MFCCs with some parameters
